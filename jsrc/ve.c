...
F2(jtintdiv){PLOG2;A z;B b,flr;I an,ar,*as,*av,c,d,j,k,m,n,p,p1,r,*s,wn,wr,*ws,*wv,*zv;
 RZ(a&&w);
...
static F2(jtweight){PLOG2;RZ(a&&w); R df1(behead(over(AR(w)?w:reshape(a,w),one)),bsdot(slash(ds(CSTAR))));}

F1(jtbase1){PLOG1;A z;B*v;I c,d,m,n,p,r,*s,t,*x;
 RZ(w);
...
F2(jtbase2){PLOG2;I ar,*as,at,c,t,wr,*ws,wt;
 RZ(a&&w);
...
F1(jtabase1){PLOG1;A d,z;B*zv;I c,n,p,r,t,*v,x;
 RZ(w);
...
F2(jtabase2){PLOG2;A z;I an,ar,at,wn,wr,wt,zn;
 RZ(a&&w);
...
F1(jtintmod2){PLOG1;A z;B*b,*v;I k=SZI,mask,m,n,q,r,*u,*wi;
 RZ(w);
