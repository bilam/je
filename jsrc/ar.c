...
static DF1(jtred0){PLOG1;DECLF;A x;I f,r,wr,*s;
...
static DF1(jtredg){PLOG1;PROLOG;DECLF;A y,z;B p;C*u,*v;I i,k,n,old,r,wr,yn,yr,*ys,yt;
 RZ(w);
...
static A jtredsp1a(J jt,C id,A z,A e,I n,I r,I*s){A t;B b,p=0;D d=1;
 switch(id){
  ...
  case CPLUS:    if(n&&equ(e,zero))R z; DO(r, d*=s[i];); t=tymes(e,d>(D)IMAX?scf(d-n):sc((I)d-n)); R n?plus (z,t):t;
  case CSTAR:    if(n&&equ(e,one ))R z; DO(r, d*=s[i];); t=expn2(e,d>(D)IMAX?scf(d-n):sc((I)d-n)); R n?tymes(z,t):t;
...
DF1(jtredravel){PLOG1;A f,x,z;C id;I cv,n;P*wp;VF ado;
 RZ(w);
 f=VAV(self)->f;
...
static DF1(jtreducesp){PLOG1;A a,g,x,y,z;B b;C id;I cv,f,n,r,rr[2],*v,wn,wr,*ws,wt,zt;P*wp;VF ado;
 RZ(w);
...
static DF1(jtreduce){PLOG1;A z;C id;I c,cv,f,m,n,r,rr[2],t,wn,wr,*ws,wt,zt;VF ado;
 RZ(w);
 wr=AR(w); r=jt->rank?jt->rank[1]:wr; f=wr-r;
 wn=AN(w); ws=AS(w); n=r?ws[f]:1;
...
static DF1(jtredcat){PLOG1;A z;B b;I f,r,*s,*v,wr;
 RZ(w);
...
static DF1(jtredsemi){PLOG1;I f,n,r,*s,wr;
 RZ(w);
...
static DF1(jtredstitch){PLOG1;A c,y;I f,n,r,*s,*v,wr;
 RZ(w);
...
static DF1(jtredstiteach){PLOG1;A*wv,y;I n,p,r,t,wd;
 RZ(w);
 n=AN(w);
...
static DF1(jtredcateach){PLOG1;A*u,*v,*wv,x,*xv,z,*zv;I f,m,mn,n,r,wd,wr,*ws,zm,zn;
 RZ(w);
...
static DF2(jtoprod){PLOG2;R df2(a,w,VAV(self)->h);}


F1(jtslash){PLOG1;A h;AF f1=jtreduce;C c;V*v;
 RZ(w);
...
DF1(jtmean){PLOG1;A z;I c,f,m,n,r,wn,wr,*ws,wt;
 RZ(w);
 wr=AR(w); r=jt->rank?jt->rank[1]:wr; f=wr-r; jt->rank=0;
