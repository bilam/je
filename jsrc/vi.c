...
F2(jtindexof){PLOG2;R indexofsub(IIDOT,a,w);}
     /* a i."r w */

F2(jtjico2){PLOG2;R indexofsub(IICO,a,w);}
     /* a i:"r w */
...
F2(jtless){PLOG2;A x=w;I ar,at,k,r,*s,wr,*ws,wt;
 RZ(a&&w);
 at=AT(a); ar=AR(a); 
...
F1(jtnubind0){PLOG1;A z;D oldct=jt->ct;
 RZ(w);
...
F1(jtsclass){PLOG1;A e,x,xy,y,z;I c,j,m,n,*v;P*p;
 RZ(w);
