...
B jtprobedel(J jtfg,C*string,UI4 hash,A g){F12JT0;/* CHKAPX(g); */ B ret;
...
A jtsyrd1(J jtfg,C *string,UI4 hash,A g){F12JT0;CHKAPX(g);A*v,x,y;
...
A jtsyrd1forlocale(J jtfg,C *string,UI4 hash,A g){F12JT0;CHKAPX(g);
 RZ(g);   // make sure there is a locale...
...
static L *jtprobeforsym(J jtfg,C*string,UI4 hash,A g){F12JT0; /* CHKAPX(g); */
 RZ(g);
