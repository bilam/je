...
static F2(jtcut02m){PLOG2;A z;C*u,*v;I*av,c,d,e0,e1,j0,j1,k0,k1,m0,m1,*s,t,wk;
...
static DF2(jtcut02){PLOG2;DECLF;A h=0,*hv,q,qq,*qv,y,z,*zv;C id;I*as,c,d,e,hn,i,ii,j,k,m,n,*u,*ws;
 RZ(a&&w);
...
DF2(jtrazecut0){PLOG2;A z;C*v,*wv,*zu,*zv;I ar,*as,*av,c,d,i,j,k,m,n,q,wt,zn;
 RZ(a&&w);
...
static DF2(jtcut2bx){PLOG2;A*av,b,t,x,*xv,y,*yv;B*bv;I an,ad,bn,i,j,m,p,q,*u,*v,*ws;V*sv;
 RZ(a&&w&&self);
...
static F1(jtcps){PLOG1;A z;P*wp,*zp;
...
static DF2(jtcut2sx){PLOG2;PROLOG;DECLF;A h=0,*hv,y,yy;B b,neg,pfx,*u,*v;C id;I d,e,hn,m,n,p,t,yn,*yu,*yv;P*ap;V*vf;
 PREF2(jtcut2sx);
...
static DF2(jtcut2){PLOG2;PROLOG;DECLF;A h=0,*hv,y,z=0,*za;B b,neg,pfx;C id,id1,sep,*u,*v,*v1,*wv,*zc;
...
static DF1(jtcut1){PLOG1;R cut2(mark,w,self);}
...
DF2(jtrazecut2){PLOG2;A fs,gs,x,y,z=0;B b,neg,pfx;C id,ie=0,sep,*u,*v,*wv,*zv;I c,cv=0,d,k,m=0,n,p,q,r,*s,wt;
    V*fv,*sv,*vv;VF ado=0;
 RZ(a&&w);
...
DF1(jtrazecut1){PLOG1;R razecut2(mark,w,self);}
...
static F2(jttesa){PLOG2;A x;I*av,c,d,k,p=IMAX,r,*s,t,*u,*v;
 RZ(a&&w);
 t=AT(a);
 RZ(a=vib(a)); 
...
static DF2(jttess2){PLOG2;A gs,p,y,z;I*av,n,t;
 PREF2(jttess2);
 RZ(a=tesa(a,w)); 
...
static DF1(jttess1){PLOG1;A s;I m,r,*v;
 RZ(w);
...
F2(jtcut){PLOG2;A h=0;I flag=0,k;
 RZ(a&&w);
