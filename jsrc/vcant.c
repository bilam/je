...
static F2(jtcanta){PLOG2;A m,s,t,z;B b;C*wv,*zv;I*av,c,d,j,k,*mv,r,*sv,*tv,wf,wr,*ws,zn,zr;
 RZ(a&&w);
...
F1(jtcant1){PLOG1;I r; 
 RZ(w); 
 if(jt->rank){jt->rank[0]=1; r=jt->rank[1];}else r=AR(w); 
 R canta(apv(r,r-1,-1L),w);
}    /* |:"r w */

F2(jtcant2){PLOG2;A*av,p,t,y;I ad,j,k,m,n,*pv,q,r,*v;
 RZ(a&&w);
