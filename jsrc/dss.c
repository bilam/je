...
F1(jtdbcutback  ){PLOG1;R ssdo(0L,w,SSCUTBACK );}  /* 13!:19 */

F1(jtdbstepover1){PLOG1;R ssdo(0L,w,SSSTEPOVER);}  /* 13!:20 */
F2(jtdbstepover2){PLOG2;R ssdo(a, w,SSSTEPOVER);}

F1(jtdbstepinto1){PLOG1;R ssdo(0L,w,SSSTEPINTO);}  /* 13!:21 */
F2(jtdbstepinto2){PLOG2;R ssdo(a, w,SSSTEPINTO);}

F1(jtdbstepout1 ){PLOG1;R ssdo(0L,w,SSSTEPOUT );}  /* 13!:22 */
F2(jtdbstepout2 ){PLOG2;R ssdo(a, w,SSSTEPOUT );}
