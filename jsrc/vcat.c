...
static F2(jtovs){PLOG2;A ae,ax,ay,q,we,wx,wy,x,y,z,za,ze;B*ab,*wb,*zb;I acr,ar,*as,at,c,m,n,r,t,*v,wcr,wr,*ws,wt,*zs;P*ap,*wp,*zp;
 RZ(a&&w);
...
static F2(jtovg){PLOG2;A s,z;C*x;I ar,*as,c,k,m,n,q,r,*sv,wr,*ws,zn;
 RZ(a&&w);
...
static F2(jtovv){PLOG2;A z;I m,t;
 t=AT(a); 
...
F2(jtover){PLOG2;A z;B b;C*zv;I acn,acr,af,ar,*as,c,f,k,m,ma,mw,p,q,r,*s,t,wcn,wcr,wf,wr,*ws,zn;
 RZ(a&&w);
...
F2(jtstitch){PLOG2;B sp2;I ar,wr;
 RZ(a&&w);
...
F1(jtlamin1){PLOG1;A x;I*s,*v,wcr,wf,wr; 
 RZ(w);
...
F2(jtlamin2){PLOG2;A z;I ar,p,q,wr;
 RZ(a&&w); 
...
F2(jtapip){PLOG2;RZ(a&&w); R AC(a)>(AFNJA&AFLAG(a)?2:1)||!(DIRECT&AT(a))?over(a,w):apipx(a,w);}

F2(jtapipx){PLOG2;A h;C*av,*wv;I ak,at,ar,*as,k,p,*u,*v,wk,wm,wn,wt,wr,*ws;
 RZ(a&&w);
