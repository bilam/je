...
static F1(jtnorm){PLOG1;R sqroot(pdt(w,conjug(w)));}

F1(jtrinv){PLOG1;PROLOG;A ai,bx,di,z;I m,n,r,*s;
 F1RANK(2,jtrinv,0);
...
static F1(jtqrr){PLOG1;PROLOG;A a1,q,q0,q1,r,r0,r1,t,*tv,t0,t1,y,z;I m,n,p,*s;
 RZ(w);
...
F1(jtqr){PLOG1;A r,z;D c=inf,d=0,x;I n1,n,*s,wr;
 F1RANK(2,jtqr,0);
...
static F2(jticor){PLOG2;D d,*v;I n;
 RZ(a&&w);
 d=1; n=1+*AS(a);
...
F1(jtminv){PLOG1;PROLOG;A q,r,*v,y,z;I m,n,*s,t,wr;
 F1RANK(2,jtminv,0);
...
static F2(jtmdivsp){PLOG2;A a1,x,y;I at,d,m,n,t,*v,xt;P*wp;
...
F2(jtmdiv){PLOG2;PROLOG;A q,r,*v,y,z;B b=0;I t;
