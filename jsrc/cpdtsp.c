...
F1(jtbtreetest){PLOG1;ASSERT(0,EVDOMAIN);}
F1(jtbtreedft){PLOG1;ASSERT(0,EVDOMAIN);}
...
static F2(jtpdtspvv){PLOG2;A x;D*av,s,t,*wv,z;I i,*u,*u0,*uu,*v,*v0,*vv;P*ap,*wp;
 RZ(a&&w);
...
static F2(jtpdtspmv){PLOG2;A ax,b,g,x,wx,y,yi,yj,z;B*bv;I m,n,s[2],*u,*v,*yv;P*ap,*wp,*zp;
 RZ(a&&w);
...
static F2(jtpdtspvm){PLOG2;A ax,b,g,x,wx,y,yi,yj,z;B*bv;D*av,c,d,*wv,*xv;I m,n,s[2],*u,*v,*yv;P*ap,*wp,*zp;
 RZ(a&&w);
...
static F2(jtpdtspmm){PLOG2;A z,zi,zj,zx,zy;D*axv,c,d,*dv,*wxv,*zyv;
...
F2(jtpdtsp){PLOG2;A x;B ab=0,wb=0;P*p;
 RZ(a&&w);
