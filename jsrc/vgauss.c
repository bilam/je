...
F1(jtgausselm){PLOG1;A t;C*tv;I c,e,i,j,m,old,r,r1,*s;Q p,*u,*v,*x;
...
static F1(jtdetr){PLOG1;A t,z;C*tv;I c,e,g=1,i,j,k,m,old,r,*s;Q d,p,*u,*v,*x;
 RZ(w);
 s=AS(w); r=s[0]; c=s[1];
 v=QAV(w); 
...
static F1(jtdetd){PLOG1;D g,h,p,q,*u,*v,*x,*y,z=1.0;I c,d,e,i,j,k,r,*s;
 RZ(w);
...
static F1(jtdetz){PLOG1;A t;D g,h;I c,d,e,i,j,k,r,*s;Z p,q,*u,*v,*x,*y,z;
 RZ(w);
 z.re=1.0; z.im=0.0;
