...
F1(jtlock1){PLOG1;A z; C* p; C* src;
...
F2(jtlock2){PLOG2;ASSERT(0,EVDOMAIN);}

F1(jtunlock1){PLOG1;R unlock2(mtv,w);}

F2(jtunlock2){PLOG2;int i,j,len,tlen;UC c1,c2,k1[SK],*lp,*sp,*d;
 RZ(a&&w);  
 d=(UC*)CAV(w);
 tlen=(int)AN(w);
