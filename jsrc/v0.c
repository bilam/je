...
static F1(jtrsort){PLOG1;A t,z;D d=jt->ct;
 RZ(w);
 jt->ct=jt->fuzz;
...
static F2(jtcfrz){PLOG2;A z;B b=0,p;I j,n;Z c,d,*t,*u,*v;
 RZ(w=rsort(w)); 
 n=AN(w); u=ZAV(w); 
...
static F1(jtcfr){PLOG1;A c,r,*wv;I t,wd;
...
static F1(jtrfc){PLOG1;A r,w1;I m=0,n,t;
 n=AN(w); t=AT(w);
 if(n){
...
static F2(jtpoly2a){PLOG2;A c,e,x;I m;
 RZ(a&&w);
 m=*(1+AS(a))-1;
...
F2(jtpoly2){PLOG2;A c,z;B b;D*ad,d,p,*wd,x,*zd;I an,at,j,t,wn,wt;Z*az,e,q,*wz,y,*zz;
 RZ(a&&w);
