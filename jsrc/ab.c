...
DF2(jtbitwisechar){DECLFG;A*p,x,y,z;B b;I an,ar,*as,at,d,j,m,n,wn,wr,*ws,wt,zn;VF f;
 ...
 if(1==n)                 {f=(VF)bwI[j]; m=(m+d-1)/d;}
 else if(!ar||!wr||0==n%d){f=(VF)bwI[j]; n=(n+d-1)/d; p=b?&x:&y; RZ(*p=irs2(sc(d),*p,0L,0L,0L,jtrepeat));}
 else                      f=(VF)bwC[j];
...
static VF bwinsC[16]={(VF)bw0000insC,(VF)bw0001insC,(VF)bw0010insC,(VF)bw0011insC, (VF)bw0100insC,(VF)bw0101insC,(VF)bw0110insC,(VF)bw0111insC,
                      (VF)bw1000insC,(VF)bw1001insC,(VF)bw1010insC,(VF)bw1011insC, (VF)bw1100insC,(VF)bw1101insC,(VF)bw1110insC,(VF)bw1111insC};

static VF bwinsI[16]={(VF)bw0000insI,(VF)bw0001insI,(VF)bw0010insI,(VF)bw0011insI, (VF)bw0100insI,(VF)bw0101insI,(VF)bw0110insI,(VF)bw0111insI,
                      (VF)bw1000insI,(VF)bw1001insI,(VF)bw1010insI,(VF)bw1011insI, (VF)bw1100insI,(VF)bw1101insI,(VF)bw1110insI,(VF)bw1111insI};
...
DF1(jtbitwiseinsertchar){A fs,z;I c,d=SZI,j,m,n,r,wn,wr;UC*u,*v,*wv,x,*zv;VF f;
 ...
 m=wn/n; wv=CAV(w); j=i0(VAV(fs)->f)-16; f=(VF)bwinsC[j];
 if(1==wr)switch(j){
  case  0: R scc(0);
  case  3: R scc(*wv);
  ...
  case  1: case 6: case 7: case 9: f=(VF)bwinsI[j]; c=n=n/d;
 }else if(0==m%d){f=(VF)bwinsI[j]; c/=d;}
