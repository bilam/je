...
static F2(jtmatchs){PLOG2;A ae,ax,p,q,we,wx,x;B*b,*pv,*qv;D d;I acr,an=0,ar,c,j,k,m,n,r,*s,*v,wcr,wn=0,wr;P*ap,*wp;
 RZ(a&&w);
...
F2(jtmatch){PLOG2;A z;I af,f,m,n,*s,wf;
 RZ(a&&w);
...
F2(jtnotmatch){PLOG2;A z;I af,f,m,n,*s,wf;
 RZ(a&&w);
