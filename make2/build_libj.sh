...
case "$jplatform/$j64x" in
 ...
 windows/j32) # windows x86
  ...
  LDFLAGS=" -shared -Wl,--enable-stdcall-fixup -lm -static-libgcc -static-libstdc++ -Wl,-Bstatic -Wl,-Bdynamic -lole32 -ladvapi32 -loleaut32 -lonecore -lpsapi -lsynchronization -luuid $LDTHREAD $LDOPENMP "
  if [ $jolecom -eq 1 ]; then
 ...
 windows/j64avx2*) # windows intel 64bit avx2
  ...
  LDFLAGS=" -shared -Wl,--enable-stdcall-fixup -lm -static-libgcc -static-libstdc++ -Wl,-Bstatic -Wl,-Bdynamic -lole32 -ladvapi32 -loleaut32 -lpsapi -lsynchronization -luuid $LDTHREAD $LDOPENMP "
  CFLAGS_SIMD=" -march=skylake -mtune=skylake -msse4.1 -msse4.2 -mavx2 -mfma -mbmi -mbmi2 -mlzcnt -mmovbe -mpopcnt -mno-vzeroupper "
  if [ $jolecom -eq 1 ]; then
   DLLOBJS=" ../dllsrc/jdll.o ../dllsrc/jdllcomx.o "
   LIBJDEF=" ../dllsrc/jdll.def "
